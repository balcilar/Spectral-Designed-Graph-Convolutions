...
flags.DEFINE_list('nfilter', [160,7], 'Number of units in each layer for instance [160, 100,50]')
...
for iter in range(0,20):
    ...
    for epoch in range(FLAGS.epochs):
        ...
        #costt, acct, testx,predtt = evaluate(feat, support2, y_test, test_mask, placeholders2)
    ...
    model.load(sess)
    cost, acc, valx,predt = evaluate(feat, support2, y_val, val_mask, placeholders2)
    bvalacc=acc    
    bvalx=valx 
